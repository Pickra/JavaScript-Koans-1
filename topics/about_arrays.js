...
test("splice", function() {
    ...
    var workingWeek = daysOfWeek.splice(0, 3);
    ok(workingWeek.equalTo(['Monday', 'Tuesday', 'Wednesday']), 'what is the value of workingWeek?');
    ok(daysOfWeek.equalTo(['Thursday', 'Friday', 'Saturday', 'Sunday']), 'what is the value of daysOfWeek?');
});
